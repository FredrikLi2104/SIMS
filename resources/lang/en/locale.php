...
return [
    ...
    "componentsCreate" => "Component Create",
    "do" => "Do",
    "dpas" => "DPAs",
    "home" => "Home",
    "kpi" => "KPI",
    "kpiCreate" => "KPI Create",
    "kpis" => "KPIs",
    "organisations" => "Organisations",
    "organisationCreate" => "Organisation Create",
    "periods" => "Periods",
    "periodsCreate" => "Period Create",
    "plan" => "Plan",
    "plans" => "Plans",
    ...
    'types' => 'Types',
    'types_create' => 'Type Create',
    'currencies' => 'Currencies',
    'currencies_create' => 'Currency Create',
    'outcomes' => 'Outcomes',
    'outcomes_create' => 'Outcome Create',
    'issue_categories' => 'Issue Categories',
    'issue_categories_create' => 'Issue Category Create',
    'tags' => 'Tags',
    'tags_create' => 'Tag Create',
    'groups' => 'Groups',
