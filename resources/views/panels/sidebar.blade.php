                    ...
                    @else
                        ...
                        @can($menu->auth)
                            <li class="nav-item {{ $custom_classes }} {{ in_array(Route::currentRouteName(), $menu->slug) ? 'active' : '' }}">
                                <a href="{{ isset($menu->url) ? url(App::currentLocale() . '/' . $menu->url) : 'javascript:void(0)' }}" class="d-flex align-items-center" target="{{ isset($menu->newTab) ? '_blank' : '_self' }}">
