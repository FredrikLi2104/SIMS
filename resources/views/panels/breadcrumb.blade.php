...
<!-- Side Button -->
@if (Route::currentRouteName() == 'risks.index')
  <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
  <div class="mb-1 breadcrumb-right">
    <a href="{{ route('risks.create', App::currentLocale()) }}">
    <button class="btn btn-success btn-round">+ @lang('messages.risk') @lang('messages.create')</button>
    </a>
  </div>
  </div>
@endif
