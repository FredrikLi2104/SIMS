                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="demo-inline-spacing">
                            ...
                            <div class="d-inline-block">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#secondary">
                                    Secondary
                                </button>
                                <!-- Modal -->
                                <div class="modal fade modal-secondary text-start" id="secondary" tabindex="-1" aria-labelledby="myModalLabel1660" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                            ...
                            <div class="d-inline-block">
                                ...
                                <!-- Modal -->
                                <div class="modal fade modal-dark text-start" id="dark" tabindex="-1" aria-labelledby="myModalLabel150" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="demo-inline-spacing">
                            ...
                            <div class="modal-size-default d-inline-block">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#defaultSize">
                                    Default Modal
                                </button>
                                <!-- Modal -->
                    ...
                    <div class="card-body">
                        <div class="demo-inline-spacing">
                            ...
                            <div class="show-event-ex">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onshowbtn" data-bs-target="#onshow">
                                    On Show Event
                                </button>
                                <!-- Modal -->
                            ...
                            <div class="shown-event-ex">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onshownbtn" data-bs-target="#onshown">
                                    On Shown Event
                                </button>
                                <!-- Modal -->
                                <div class="modal fade text-start" id="onshown" tabindex="-1" aria-labelledby="myModalLabel22" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                            ...
                            <div class="hide-event-ex">
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onhidebtn" data-bs-target="#onhide">
                                    On Hide Event
                                </button>
                                <!-- Modal -->
                                <div class="modal fade text-start" id="onhide" tabindex="-1" aria-labelledby="myModalLabel23" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                            ...
                            <div class="hidden-event-ex">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onhiddenbtn" data-bs-target="#onhidden">
                                    On Hidden Event
                                </button>
                                <!-- Modal -->
                                <div class="modal fade text-start" id="onhidden" tabindex="-1" aria-labelledby="myModalLabel24" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                    ...
                    <div class="card-body">
                        <div class="demo-inline-spacing">
                            ...
                            <div class="scrolling-content-ex">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModalLong">
                            ...
                            <div class="toggle-between-modal">
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalToggle">
