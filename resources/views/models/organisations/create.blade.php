                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="+461234567" name="phone" value="{{ old('phone') }}" />
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="address1" class="form-control @error('address1') is-invalid @enderror" placeholder="Birger Jarlsgatan 4" name="address1" value="{{ old('address1') }}" />
                                        @error('address1')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="hello@organisation.se" name="email" value="{{ old('email') }}" />
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="address2" class="form-control @error('address2') is-invalid @enderror" placeholder="114 34 Stockholm, Sweden" name="address2" value="{{ old('address2') }}" />
                                        @error('address2')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="website" class="form-control @error('website') is-invalid @enderror" placeholder="https://organisation.se" name="website" value="{{ old('website') }}" />
                                        @error('website')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
