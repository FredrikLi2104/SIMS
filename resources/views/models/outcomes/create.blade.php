            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('messages.outcomes') {{ $action_msg }} @lang('messages.allFields')</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="desc-en"
                                               ...
                                               placeholder="Rejected" name="desc_en"
                                               value="{{ ($is_update ?? false) ? old('desc_en') ?? $outcome->desc_en : old('desc_en') }}"/>
                                        @error('desc_en')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="desc-se"
                                               ...
                                               placeholder="Avvisad" name="desc_se"
                                               value="{{ ($is_update ?? false) ? old('desc_se') ?? $outcome->desc_se : old('desc_se') }}"/>
                                        @error('desc_se')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
...
@section('page-script')
    ...
    @if ($is_update ?? false)
        {!! JsValidator::formRequest('App\Http\Requests\OutcomeUpdateRequest', '#form') !!}
    @else
        {!! JsValidator::formRequest('App\Http\Requests\OutcomeStoreRequest', '#form') !!}
    @endif
@endsection
