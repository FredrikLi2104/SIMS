                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="content_en" class="form-control @error('content_en') is-invalid @enderror" rows="3" placeholder="We have defined a lawful basis for all processes." name="content_en">N/A</textarea>
                                        @error('content_en')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="content_se" class="form-control @error('content_se') is-invalid @enderror" rows="3" placeholder="Vi har definierat en laglig grund för alla processer." name="content_se">N/A</textarea>
                                        @error('content_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="desc_se" class="form-control @error('desc_se') is-invalid @enderror" rows="3" placeholder="Det innebär att alla personuppgifter behöver ett specifikt juridiskt stöd enligt DGPR. Utan juridiskt stöd är processen olaglig. De rättsliga grunderna regleras i artikel 6 GDPR och för känsliga personuppgifter krävs en extra laglig grund enligt artikel 9 GDPR." name="desc_se">N/A</textarea>
                                        @error('desc_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k1_en" class="form-control @error('k1_en') is-invalid @enderror" rows="3" placeholder="We have a strategy or action plan, or we have regulated it by agreement" name="k1_en">N/A</textarea>
                                        @error('k1_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k1_se" class="form-control @error('k1_se') is-invalid @enderror" rows="3" placeholder="Vi har en strategi eller handlingsplan, alternativt reglerat det genom avtal" name="k1_se">N/A</textarea>
                                        @error('k1_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k2_en" class="form-control @error('k2_en') is-invalid @enderror" rows="3" placeholder="We have a strategy or action plan, or we have regulated it by agreement" name="k2_en">N/A</textarea>
                                        @error('k2_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k2_se" class="form-control @error('k2_se') is-invalid @enderror" rows="3" placeholder="Vi har en strategi eller handlingsplan, alternativt reglerat det genom avtal" name="k2_se">N/A</textarea>
                                        @error('k2_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k3_en" class="form-control @error('k3_en') is-invalid @enderror" rows="3" placeholder="We have a strategy or action plan, or we have regulated it by agreement" name="k3_en">N/A</textarea>
                                        @error('k3_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k3_se" class="form-control @error('k3_se') is-invalid @enderror" rows="3" placeholder="Vi har en strategi eller handlingsplan, alternativt reglerat det genom avtal" name="k3_se">N/A</textarea>
                                        @error('k3_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k4_en" class="form-control @error('k4_en') is-invalid @enderror" rows="3" placeholder="We have a strategy or action plan, or we have regulated it by agreement" name="k4_en">N/A</textarea>
                                        @error('k4_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k4_se" class="form-control @error('k4_se') is-invalid @enderror" rows="3" placeholder="Vi har en strategi eller handlingsplan, alternativt reglerat det genom avtal" name="k4_se">N/A</textarea>
                                        @error('k4_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k5_en" class="form-control @error('k5_en') is-invalid @enderror" rows="3" placeholder="We have a strategy or action plan, or we have regulated it by agreement" name="k5_en">N/A</textarea>
                                        @error('k5_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="k5_se" class="form-control @error('k5_se') is-invalid @enderror" rows="3" placeholder="Vi har en strategi eller handlingsplan, alternativt reglerat det genom avtal" name="k5_se">N/A</textarea>
                                        @error('k5_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="implementation_en" class="form-control @error('implementation_en') is-invalid @enderror" rows="3" placeholder="Show the user (DPO) how to implement a plan for this statement" name="implementation_en">N/A</textarea>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="implementation_se" class="form-control @error('implementation_se') is-invalid @enderror" rows="3" placeholder="Visa användaren (DPO) hur man implementerar en plan för denna programsats" name="implementation_se">N/A</textarea>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="guide_en" class="form-control @error('guide_en') is-invalid @enderror" rows="3" placeholder="Guide the auditor (DSO) how to review this statement" name="guide_en">N/A</textarea>
                                        @error('guide_en')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea id="guide_se" class="form-control @error('guide_se') is-invalid @enderror" rows="3" placeholder="Vägleda revisorn (DSO) hur man granskar detta uttalande" name="guide_se">N/A</textarea>
                                        @error('guide_se')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
