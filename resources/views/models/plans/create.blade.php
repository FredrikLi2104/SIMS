...
@section('title', trans('messages.plan') . ' ' . trans('messages.create'))
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('messages.plan') @lang('messages.create') @lang('messages.allFields')</h4>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form id="form" class="form" action="{{ route('plans.store', App::currentLocale()) }}" method="POST">
                            @csrf
                            <div class="row">
...
@section('page-script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\PlanStoreRequest', '#form') !!}
@endsection
