                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" class="form"
                              action="{{ route('users.update', [App::currentLocale(), $user->id]) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="name"
                                               ...
                                               placeholder="John Smith" name="name" value="{{ $user->name }}"/>
                                        @error('name')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="email"
                                               ...
                                               placeholder="john@example.com" name="email" value="{{ $user->email }}"/>
                                        @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="password"
                                               ...
                                               placeholder="some$TRong_Pass" name="password" aria-label="password"
                                               aria-describedby="generate" value="{{ old('password') }}"/>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select id="role"
                                            ...
                                            @foreach ($roles as $desc=>$role)
                                                <option @selected($user->role == $role) value={{ $role }}>{{$desc}}
                                                    ({{ $role }})
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select id="organisation_id"
                                            ...
                                            @foreach ($organisations as $organisation)
                                                <option
                                                    @selected($user->organisation?->id == $organisation->id) value="{{ $organisation->id }}">{{ $organisation->name }}</option>
                                            @endforeach
                                        </select>
