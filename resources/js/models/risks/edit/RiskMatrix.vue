...
export default {
    ...
    mounted() {
        ...
        axios
            .get(`/${thisComponent.locale}/axios/risks/${thisComponent.risk_id}`, {})
            .then(function (response) {
                console.log(response.data);
                thisComponent.collection = response.data;
                thisComponent.prob = thisComponent.collection.risk?.probability;
                thisComponent.cons = thisComponent.collection.risk?.consequence;
            })
