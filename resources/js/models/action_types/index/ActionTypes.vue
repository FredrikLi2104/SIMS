    ...
    methods: {
        initDatatable() {
            ...
            self.datatable = $('#datatable').DataTable({
                ajax: {
                    url: `/${self.locale}/axios/action_types`,
                    dataSrc: null
                },
                columns: [
                    {data: 'id'},
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            if (self.canUpdate) {
                                r += `<a href="/${self.locale}/action_types/${full.id}/edit" class="btn btn-primary waves-effect waves-float waves-light text-nowrap">${self.messages.edit}</a>`;
                            }
